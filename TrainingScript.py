...
CONFIG_PATH = './configs'
train_dir = '/mnt/data/analysis_1000mem/sampled_data/train'
validation_dir = '/mnt/data/analysis_1000mem/sampled_data/validation'
...
if args_dict['fourier_encoding']:
    ...
    if args_dict['parametric_encoding']:
        in_channels = grid_channels * num_levels + 2 * args_dict['n_fourier_features'] + 3
else:
    in_channels = 3
